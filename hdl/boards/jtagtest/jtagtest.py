...
class JTAGTest(AbstractBoard):
    ...
    def rtl(self):
        ...
        self.led0 = PseudoLED("JTAGTest", "LED0", self.state0, color="WHITE")
        self.led1 = PseudoLED("JTAGTest", "LED1", self.state1, color="RED")
        self.led2 = PseudoLED("JTAGTest", "LED2", self.state2, color="GREEN")
        self.led3 = PseudoLED("JTAGTest", "LED3", self.state3, color="YELLOW")
        self.led4 = PseudoLED("JTAGTest", "LED4", self.state4, color="BLUE")
