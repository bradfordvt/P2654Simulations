...
class JTAG2Test(AbstractBoard):
    ...
    def rtl(self):
        ...
        self.led0 = PseudoLED("JTAG2Test", "LED0", self.state0, color="WHITE")
        self.led1 = PseudoLED("JTAG2Test", "LED1", self.state1, color="RED")
        self.led2 = PseudoLED("JTAG2Test", "LED2", self.state2, color="GREEN")
        self.led3 = PseudoLED("JTAG2Test", "LED3", self.state3, color="YELLOW")
        self.led4 = PseudoLED("JTAG2Test", "LED4", self.state4, color="BLUE")
